...
namespace PhanMemQuanLiThiTracNghiem
{
    internal class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.calendar2;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.calendar2;
                else calendarIcon = Properties.Resources.calendar2;
                this.Invalidate();
            }
        }
        ...
        public Image CalendarIcon { get => calendarIcon; set => calendarIcon = value; }
        public Image CalendarIcon1 { get => calendarIcon; set => calendarIcon = value; }
