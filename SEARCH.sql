...
select SINHVIEN.MSSV,HOTENSV,SINHVIEN.MALOP,LOP.MAKHOA,KHOA.TENKHOA,GIOITINHSV,NGAYSINHSV,PASSWORDSV,ENABLESV FROM SINHVIEN INNER JOIN SVACCOUNTS ON SINHVIEN.MSSV = SVACCOUNTS.MSSV INNER JOIN LOP ON LOP.MALOP = SINHVIEN.MALOP INNER JOIN KHOA ON KHOA.MAKHOA = SINHVIEN.MAKHOA ORDER BY MSSV ASC
